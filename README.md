...
- [💛 Monobank Donate](#-monobank-donate)
  ...
  - [🚀 Інсталяція](#-інсталяція)
    - [Вимоги](#вимоги)
    - [Автоматичне налаштування (рекомендовано)](#автоматичне-налаштування-рекомендовано)
    - [Ручне налаштування](#ручне-налаштування)
      - [Backend](#backend-1)
      - [Frontend](#frontend-1)
  ...
  - [🐳 Запуск через Docker](#-запуск-через-docker)
    - [Налаштування Docker](#налаштування-docker)
      - [Frontend](#frontend-3)
      - [Backend](#backend-3)
...
Проект можна запустити за допомогою Docker і Docker Compose:

### Використання зручного скрипта (рекомендовано)

```bash
# Запустити інтерактивний скрипт керування Docker
node docker-start.js
```

Скрипт пропонує зручне меню для:
- Запуску проекту в режимі розробки або продакшену
- Зупинки контейнерів
- Перегляду логів
- Перезапуску або перебудови проекту
...
Для налаштування фронтенду і бекенду через Docker:

#### Frontend

У контейнері фронтенду використовується NGINX для роздачі статичних файлів. 
Налаштування CORS і API_URL відбувається під час збірки.

#### Backend

Бекенд автоматично налаштовує CORS для взаємодії з фронтендом в Docker-мережі.
Змінні середовища можна налаштувати в `docker-compose.yml` файлі.
