...
Проект використовує центральний скрипт керування `manage-project.js`, який об'єднує всі функції для роботи з проектом.
...
- **Запуск проекту**
  - Локальний запуск frontend і backend
...
Після запуску з'явиться інтерактивне меню з доступними опціями:

- **Налаштування:** налаштування середовища, Docker, .env файлів
- **Docker:** запуск, зупинка, логи, статус контейнерів
- **Локальний запуск:** запуск frontend і backend без Docker
