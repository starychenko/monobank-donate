    ...
    <div className="card donation-card w-full md:max-w-[480px] box-border m-0">
      ...
      <div className="donation-card-content">
        ...
        <div className="donation-card-stats">
          ...
          <div className="donation-card-stat flex-1 flex flex-col items-center">
            <span className="donation-card-stat-label mb-1">
              Накопичено
            </span>
            <div className="flex items-center gap-2">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="donation-card-icon">
